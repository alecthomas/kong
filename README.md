...
| `xor:"X,Y,..."`      | Exclusive OR groups for flags and non-branching positional arguments. Only one value in the group can be used within the same command. When combined with `required`, at least one member of the `xor` group will be required.                                                                                               |
